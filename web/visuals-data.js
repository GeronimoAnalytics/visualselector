window.CATALOG_DATA = {
  "meta": {
    ...
    "source": "PowerBI_Visual_Catalogus.xlsx",
    "sheet": "Visual Catalogus",
    "count": 79
  },
  "tooltips": {
    "ordered": {
  ...
  "visuals": [
    {
      ...
      "goal": "comparison",
      "complexity": "Laag",
      "whatIsIt": "Een diagram met horizontale staven waarbij categorieën direct onder elkaar worden getoond om waarden te vergelijken.",
    ...
    },
    {
      ...
      "goal": "comparison",
      "complexity": "Laag",
      "whatIsIt": "Een horizontale staafdiagram waarin subcategorieën op of achter elkaar worden gestapeld binnen één totale balk.",
    ...
    },
    {
      ...
      "goal": "comparison",
      "complexity": "Laag",
      "whatIsIt": "Een horizontale staafdiagram waarin alle balken tot 100% reiken en de segmenten het procentuele aandeel tonen.",
      "whenToUse": "Wanneer de focus volledig ligt op de procentuele verdeling/verhouding binnen de categorieën, ongeacht de absolute volumes.",
      "whenNotToUse": "Wanneer de absolute aantallen of totale volumes cruciaal zijn om te tonen.",
      "imagePath": "images/100pct-stacked-bar-chart.png",
      "iconPath": "",
      "svgIcon": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 64'><defs><linearGradient id='bg' x1='0' y1='0' x2='0' y2='1'><stop offset='0%' stop-color='#EAF6FF'/><stop offset='100%' stop-color='#CFE8F7'/></linearGradient></defs><rect x='1' y='1' width='94' height='62' rx='10' fill='url(#bg)' stroke='#7EA9C3'/><rect x='12' y='14' width='30' height='8' fill='#0B4F8A'/><rect x='12' y='27' width='46' height='8' fill='#1492C5'/><rect x='12' y='40' width='62' height='8' fill='#F2C24D'/></svg>",
      "orderType": "unordered",
      "dataType": "both"
    },
    {
      ...
      "goal": "comparison",
      "complexity": "Laag",
      "whatIsIt": "Een diagram met verticale kolommen waarbij categorieën naast elkaar worden gezet om waarden te vergelijken.",
    ...
    },
    {
      ...
      "goal": "comparison",
      "complexity": "Laag",
      "whatIsIt": "Een verticale kolomdiagram waarin subcategorieën bovenop elkaar worden gestapeld om de totale waarde te vormen.",
    ...
    },
    {
      ...
      "goal": "comparison",
      "complexity": "Laag",
      "whatIsIt": "Een verticale kolomdiagram waarbij elke kolom tot 100% reiken en de segmenten het relatieve aandeel weergeven.",
      "whenToUse": "Om te zien hoe de onderlinge verhoudingen binnen een categorie veranderen over een beperkt aantal periodes of groepen.",
      "whenNotToUse": "Wanneer de absolute waarden/volumes achter de percentages belangrijk zijn voor de besluitvorming.",
      "imagePath": "images/100pct-stacked-column-chart.png",
      "iconPath": "",
      "svgIcon": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 64'><defs><linearGradient id='bg' x1='0' y1='0' x2='0' y2='1'><stop offset='0%' stop-color='#EAF6FF'/><stop offset='100%' stop-color='#CFE8F7'/></linearGradient></defs><rect x='1' y='1' width='94' height='62' rx='10' fill='url(#bg)' stroke='#7EA9C3'/><rect x='18' y='30' width='12' height='20' fill='#0B4F8A'/><rect x='36' y='20' width='12' height='30' fill='#1492C5'/><rect x='54' y='12' width='12' height='38' fill='#F2C24D'/><line x1='12' y1='50' x2='82' y2='50' stroke='#4F7A94'/></svg>",
      "orderType": "unordered",
      "dataType": "both"
    },
    {
      ...
      "goal": "time-series",
      "complexity": "Laag",
      "whatIsIt": "Een diagram dat datapunten verbindt met een doorlopende lijn om trends over de tijd te tonen.",
    ...
    },
    {
      ...
      "goal": "time-series",
      "complexity": "Laag",
      "whatIsIt": "Een lijndiagram waarbij het gebied onder de lijn is ingekleurd om het totale volume te benadrukken.",
    ...
    },
    {
      ...
      "goal": "time-series",
      "complexity": "Laag",
      "whatIsIt": "Een area chart waarin de vlakken van subcategorieën op elkaar zijn gestapeld om de opbouw van het totaal te tonen.",
    ...
    },
    {
      ...
      "goal": "time-series",
      "complexity": "Laag",
      "whatIsIt": "Een diagram dat categorieën over de tijd verbindt met vloeiende linten die van positie wisselen op basis van rangschikking.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Laag",
      "whatIsIt": "Een diagram dat de cumulatieve opbouw of afbouw toont van een beginwaarde naar een eindwaarde door opeenvolgende mutaties.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een combinatiediagram met gegroepeerde kolommen en een lijn over twee verschillende assen (Y1 en Y2).",
    ...
    },
    {
      ...
      "name": "Line and Stacked Column Chart",
      "kind": "Visual",
      "category": "Combinatie",
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een combinatiediagram met gestapelde kolommen en een lijn over twee verschillende assen.",
    ...
    },
    {
      ...
      "goal": "part-to-whole",
      "complexity": "Laag",
      "whatIsIt": "Een cirkeldiagram dat het aandeel van categorieën in een totaal (100%) laat zien.",
    ...
    },
    {
      ...
      "goal": "part-to-whole",
      "complexity": "Laag",
      "whatIsIt": "Een cirkeldiagram met een open centrum, functioneel identiek aan de pie chart.",
    ...
    },
    {
      ...
      "goal": "part-to-whole",
      "complexity": "Laag",
      "whatIsIt": "Een visualisatie die data weergeeft als geneste rechthoeken, waarbij de grootte het volume representeert.",
    ...
    },
    {
      ...
      "goal": "flow",
      "complexity": "Laag",
      "whatIsIt": "Een trechterdiagram dat de lineaire progressie van data door opeenvolgende, afhankelijke fasen toont.",
    ...
    },
    {
      ...
      "goal": "relationship",
      "complexity": "Laag",
      "whatIsIt": "Een diagram dat datapunten op een x- en y-as plaatst om de correlatie tussen twee numerieke variabelen te tonen.",
    ...
    },
    {
      ...
      "goal": "relationship",
      "complexity": "Laag",
      "whatIsIt": "Een scatter chart waarbij de grootte van de datapunten (bellen) een derde numerieke variabele vertegenwoordigt.",
    ...
    },
    {
      ...
      "goal": "relationship",
      "complexity": "Laag",
      "whatIsIt": "Een diagram dat discrete datapunten weergeeft als stippen op een as om frequenties of verdelingen te tonen.",
    ...
    },
    {
      ...
      "goal": "detail",
      "complexity": "Laag",
      "whatIsIt": "Een standaard grid dat data plat weergeeft in rijen en kolommen.",
    ...
    },
    {
      ...
      "goal": "detail",
      "complexity": "Laag",
      "whatIsIt": "Een kruistabel (pivot table) die data aggregeert en waarmee je kunt in- en uitzoomen op verschillende hiërarchische niveaus.",
    ...
    },
    {
      ...
      "goal": "kpi",
      "complexity": "Laag",
      "whatIsIt": "Een visual die één enkele belangrijke waarde of KPI prominent weergeeft.",
    ...
    },
    {
      ...
      "goal": "kpi",
      "complexity": "Laag",
      "whatIsIt": "De vernieuwde, multifunctionele card visual waarmee je meerdere kaarten in één container kunt groeperen met rijke opmaakopties.",
      "whenToUse": "Wanneer je een modern KPI-banner wilt bouwen met ingebouwde afbeeldingen, flexibele labels en geavanceerde styling.",
      "whenNotToUse": "Wanneer een simpele, ouderwetse kaart volstaat en prestatie/compatibiliteit met zeer oude rapporten vereist is.",
      "imagePath": "images/card-(new).png",
      "iconPath": "",
      "svgIcon": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 64'><defs><linearGradient id='bg' x1='0' y1='0' x2='0' y2='1'><stop offset='0%' stop-color='#EAF6FF'/><stop offset='100%' stop-color='#CFE8F7'/></linearGradient></defs><rect x='1' y='1' width='94' height='62' rx='10' fill='url(#bg)' stroke='#7EA9C3'/><rect x='14' y='14' width='68' height='36' rx='6' fill='white' stroke='#9BC2DA'/><text x='48' y='37' text-anchor='middle' font-size='14' font-family='Segoe UI, Arial' fill='#0B4F8A'>1.2M</text></svg>",
      "orderType": "ordered",
      "dataType": "numeric"
    },
    {
      ...
      "goal": "kpi",
      "complexity": "Laag",
      "whatIsIt": "Een kaart die meerdere gerelateerde waarden of velden in een compacte lijstvorm onder elkaar toont per categorie.",
    ...
    },
    {
      ...
      "goal": "kpi",
      "complexity": "Laag",
      "whatIsIt": "Een visual die een huidige waarde toont ten opzichte van een doelwaarde (target), inclusief een trendlijn op de achtergrond.",
    ...
    },
    {
      ...
      "goal": "kpi",
      "complexity": "Laag",
      "whatIsIt": "Een halfronde meter die de voortgang van een specifieke waarde richting een einddoel of limiet visualiseert.",
    ...
    },
    {
      ...
      "goal": "kpi",
      "complexity": "Laag",
      "whatIsIt": "Een Power BI service-integratie om specifieke business doelen, scorecards en subdoelen organisatie-breed te volgen.",
      "whenToUse": "Voor het inrichten van strategische scorecards waarbij teams handmatig of automatisch hun voortgang kunnen updaten.",
      "whenNotToUse": "Voor reguliere, gedetailleerde operationele datavisualisaties in een rapport.",
      "imagePath": "images/goals---metrics.png",
      "iconPath": "",
      "svgIcon": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 64'><defs><linearGradient id='bg' x1='0' y1='0' x2='0' y2='1'><stop offset='0%' stop-color='#EAF6FF'/><stop offset='100%' stop-color='#CFE8F7'/></linearGradient></defs><rect x='1' y='1' width='94' height='62' rx='10' fill='url(#bg)' stroke='#7EA9C3'/><rect x='14' y='14' width='42' height='36' rx='6' fill='white' stroke='#9BC2DA'/><polyline points='20,40 28,34 36,36 46,24' fill='none' stroke='#1492C5' stroke-width='2'/><circle cx='68' cy='32' r='12' fill='#F2C24D'/><path d='M62 33 L67 38 L75 27' fill='none' stroke='#1C5E2A' stroke-width='3'/></svg>",
      "orderType": "ordered",
      "dataType": "numeric"
    },
    {
      ...
      "name": "Azure Maps",
      "kind": "Visual",
      "category": "Geografisch",
      "goal": "map",
      "complexity": "Laag",
      "whatIsIt": "Een geavanceerde, krachtige kaartvisual met extra lagen, 3D-weergaven en betere prestaties voor grote datasets.",
    ...
    },
    {
      ...
      "goal": "map",
      "complexity": "Laag",
      "whatIsIt": "Een geografische kaart (Bing Maps) die data weergeeft met bellen op specifieke locaties.",
    ...
    },
    {
      ...
      "goal": "map",
      "complexity": "Laag",
      "whatIsIt": "Een kaart waarbij complete geografische regio's (landen, provincies) worden ingekleurd op basis van een waarde.",
    ...
    },
    {
      ...
      "goal": "map",
      "complexity": "Laag",
      "whatIsIt": "Een kaartvisual die de focus legt op relatieve vergelijkingen van regio's met behulp van custom TopoJSON-bestanden.",
    ...
    {
      "id": "arcgis-maps-for-power-bi",
      "name": "ArcGIS Maps for Power BI",
      "kind": "Visual",
      "category": "Geografisch",
      "goal": "map",
      "complexity": "Laag",
      "whatIsIt": "Een professionele GIS-kaartintegratie van Esri met geavanceerde demografische data en analysemogelijkheden.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een AI-visual waarmee je een geaggregeerde metric stapsgewijs kunt ontleden over meerdere dimensies naar keuze.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een AI-gestuurde visual die analyseert welke factoren of segmenten een specifieke metric het meest beïnvloeden.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een AI-visual die automatisch een dynamische tekstuele samenvatting en inzichten genereert op basis van de rapportdata.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een interactief invoerveld waarmee gebruikers in natuurlijke taal (Engels/Nederlands) vragen kunnen stellen over de data.",
      "whenToUse": "Om self-service te stimuleren, zodat eindgebruikers zelf snel ad-hoc visuals kunnen genereren door een vraag te typen.",
      "whenNotToUse": "Als het onderliggende datamodel niet strak is ingericht met duidelijke synoniemen en relaties.",
      "imagePath": "images/q&a-visual.png",
      "iconPath": "",
      "svgIcon": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 64'><defs><linearGradient id='bg' x1='0' y1='0' x2='0' y2='1'><stop offset='0%' stop-color='#EAF6FF'/><stop offset='100%' stop-color='#CFE8F7'/></linearGradient></defs><rect x='1' y='1' width='94' height='62' rx='10' fill='url(#bg)' stroke='#7EA9C3'/><rect x='14' y='14' width='68' height='36' rx='5' fill='white' stroke='#9BC2DA'/><line x1='20' y1='24' x2='74' y2='24' stroke='#0B4F8A'/><line x1='20' y1='31' x2='70' y2='31' stroke='#1492C5'/><line x1='20' y1='38' x2='62' y2='38' stroke='#1492C5'/></svg>",
      "orderType": "both",
      "dataType": "both"
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een statisch of dynamisch element om afbeeldingen (zoals logo's of productfoto's) in het rapport te tonen.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een element om opgemaakte tekst, titels, beschrijvingen of hyperlinks toe te voegen aan het rapporttabblad.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Vormelementen (zoals rechthoeken, lijnen, pijlen) om de lay-out van het dashboard te structureren.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een interactieve knop waaraan een actie kan worden gekoppeld, zoals paginanavigatie of het toepassen van een bookmark.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een dynamisch menu-element dat automatisch knoppen genereert voor alle (zichtbare) pagina's in het rapport.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een dynamisch menu-element dat automatisch knoppen genereert op basis van een specifieke bookmark-groep.",
    ...
    },
    {
      ...
      "name": "Power Apps Visual",
      "kind": "Integratie",
      "category": "Workflow",
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een embedded applicatie waarmee gebruikers data kunnen inzien én direct kunnen aanpassen of invoeren (write-back) vanuit het rapport.",
    ...
    },
    {
      ...
      "name": "Power Automate Visual",
      "kind": "Integratie",
      "category": "Workflow",
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een knop binnen het rapport die direct een geautomatiseerde cloud-workflow (bijv. e-mail of alert) start buiten Power BI.",
    ...
    {
      "id": "paginated-report-visual",
      "name": "Paginated Report Visual",
      "kind": "Integratie",
      "category": "Rapportage",
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een element waarmee je een pixel-perfect, printbaar paginated rapport kunt embedden binnen een interactief Power BI dashboard.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een visualisatie die volledig gegenereerd is met behulp van Python scripts en bibliotheken zoals matplotlib of seaborn.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Een visualisatie gegenereerd met R-scripts, vergelijkbaar met de Python visual.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Laag",
      "whatIsIt": "Het fundamentele, interactieve filterelement op het rapportcanvas waarmee gebruikers de data visueel kunnen segmenteren.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een ingebouwd paneel in Power BI waarmee je dynamische referentielijnen (zoals gemiddelden of trends) aan visuals kunt toevoegen.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een ingebouwde AI-functie in het Analytics Pane die op basis van historische data een voorspelling doet voor toekomstige perioden.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een AI-functie die automatisch uitschieters (anomalieën) in een tijdreeks detecteert en de mogelijke verklaringen hiervoor toont.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Foutbalken die de variabiliteit of onzekerheid van datapunten visualiseren (bijv. standaarddeviatie of marges).",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een horizontale of verticale referentielijn die het gemiddelde van de getoonde datapunten weergeeft.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een handmatig of dynamisch ingestelde vaste referentielijn op een specifieke waarde op de as.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een referentielijn die de mediaan (de middelste waarde) van de dataset in de visual markeert.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een referentielijn die de absolute minimumwaarde binnen de getoonde visualisatie markeert.",
    ...
    },
    {
      ...
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een referentielijn die de absolute maximumwaarde binnen de getoonde visualisatie markeert.",
    ...
    {
      "id": "percentile-line",
      "name": "Percentile Line",
      "kind": "Visualfunctie",
      "category": "Analyse",
      "goal": "analysis",
      "complexity": "Middel",
      "whatIsIt": "Een referentielijn die een specifiek percentiel (bijv. het 90ste percentiel) van de getoonde data markeert.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "De pop-up die verschijnt wanneer een gebruiker met de muis over een datapunt beweegt, om extra contextuele cijfers te tonen.",
    ...
    },
    {
      ...
      "name": "Report Page Tooltips",
      "kind": "Visualfunctie",
      "category": "Interactie",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een geavanceerde tooltip waarbij een complete, op maat gemaakte rapportpagina als pop-up verschijnt bij een datapunt.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een navigatiefunctie waarmee een gebruiker via een datapunt kan doorlikken naar een gedetailleerde detailpagina gefilterd op dat punt.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "De interactie waarbij het klikken op een categorie in visual A ervoor zorgt dat visual B volledig gefilterd wordt op die selectie.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "De interactie waarbij het klikken op een categorie het aandeel daarvan oplicht (highlight) binnen de totale balken van een andere visual.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een functie waarmee je de huidige staat van een rapportpagina (filters, zichtbaarheid van visuals) kunt opslaan en later kunt oproepen.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een functie die een visual opsplitst in een raster van meerdere kleinere versies van zichzelf, verdeeld over een categorie.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een ontwerppaneel waarin de ontwikkelaar de zichtbaarheid en de gelaagdheid (z-index) van alle objecten op de pagina kan beheren.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een instelling waarmee een slicer op pagina A synchroon filters toepast en bijwerkt op pagina B en C.",
    ...
    {
      "id": "personalize-visuals",
      "name": "Personalize Visuals",
      "kind": "Visualfunctie",
      "category": "Self Service",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een rapportinstelling waarmee eindgebruikers in de Power BI Service zelf het type of de assen van een visual kunnen aanpassen.",
    ...
    {
      "id": "visual-calculations",
      "name": "Visual Calculations",
      "kind": "Visualfunctie",
      "category": "Berekening",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een geavanceerde functie waarmee je DAX-berekeningen rechtstreeks op de data binnen één specifieke visual schrijft (zoals een running total).",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een wizard/AI-hulpmiddel om snel veelvoorkomende DAX-berekeningen te genereren zonder zelf code te schrijven.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een functie waarmee gebruikers dynamisch kunnen wisselen tussen verschillende dimensies of measures binnen dezelfde visual.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een geavanceerde modelleerfunctie om business logica (zoals Time Intelligence) éénmalig te definiëren en toe te passen op alle measures.",
    ...
    },
    {
      ...
      "name": "Hierarchical Slicer",
      "kind": "Visualfunctie",
      "category": "Filtering",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een filterelement (slicer) waarmee je geneste, hiërarchische categorieën kunt in- en uitklappen binnen één filter.",
    ...
    },
    {
      ...
      "name": "Relative Date Slicer",
      "kind": "Visualfunctie",
      "category": "Filtering",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een datumfilter waarmee gebruikers dynamisch kunnen filteren op periodes ten opzichte van de huidige dag.",
    ...
    },
    {
      ...
      "name": "Relative Time Slicer",
      "kind": "Visualfunctie",
      "category": "Filtering",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een tijdsfilter waarmee gebruikers kunnen filteren op minuten of uren ten opzichte van het huidige moment.",
    ...
    {
      "id": "dropdown-slicer",
      "name": "Dropdown Slicer",
      "kind": "Visualfunctie",
      "category": "Filtering",
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een compact filtermenu dat openklapt wanneer de gebruiker erop klikt, waardoor het minimale ruimte inneemt.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een filterelement dat alle beschikbare filteropties direct als een open lijst met selectievakjes op het scherm toont.",
    ...
    },
    {
      ...
      "goal": "mixed",
      "complexity": "Middel",
      "whatIsIt": "Een filterelement met een schuifbalk (slider) om een bereik te selecteren tussen een minimum- en maximumwaarde.",
